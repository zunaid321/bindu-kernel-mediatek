...
#define USB_CHARGER_CURRENT_UNCONFIGURED	Cust_CC_1600MA	// def CONFIG_USB_IF
#define USB_CHARGER_CURRENT_CONFIGURED		Cust_CC_1600MA	// def CONFIG_USB_IF
#define USB_CHARGER_CURRENT					Cust_CC_1600MA
